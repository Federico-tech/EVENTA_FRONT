...
export const CreateEventScreen = () => {
  ...
  const [description, setDescription] = useState ('Cocò Snow PartySabato 10 Dicembre, vestiti a tema neve e vinci ricchi premi! Stupiscici col tuo outfit e vinci un tavolo al Cocò')
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View>
        ...
        <InputText label={'Description'} containerStyle={styles.description} value={description} setValue={setDescription} multiline={true}/>
